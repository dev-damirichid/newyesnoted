            ...
            <div class="row g-0">
                <div class="col-lg-12">
                    <div class="card-body p-4 p-sm-5">
                        <h6 class="card-title text-center mb-4">Log in to {{ env('APP_NAME') }}</h6>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <div class="ms-auto position-relative">
                                        ...
                                        <input type="email" name="email"
                                            ...
                                            value="{{ old('email') }}" id="inputEmailAddress" placeholder="Email Address">
                                    </div>
                                    @error('email')
                                ...
                                <div class="col-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="remember" value="remember" type="checkbox"
                                            id="flexSwitchCheckChecked">
                                        <label class="form-check-label" for="flexSwitchCheckChecked">Remember Me</label>
                                    </div>
                                </div>
                                <div class="col-6 text-end"> <a href="{{ route('forgot-password') }}">Forgot Password
                                        ?</a>
                                </div>
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary radius-30">Log
                                            In</button>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 text-center">
                                    <p class="mb-0">Don't have an account yet? <a href="{{ route('register') }}">Register
                                            here</a></p>
                                </div>
                            </div>
                        </form>
